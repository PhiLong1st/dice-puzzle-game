...
public class IncomingDiceTemplate {
  private static readonly Dictionary<IncomingDiceTypeTemplate, int[,]> storage = new() {
    { IncomingDiceTypeTemplate.Type1, new int[2, 2] { { 1, 0 }, { 1, 0 } } },
    { IncomingDiceTypeTemplate.Type2, new int[2, 2] { { 1, 1 }, { 0, 0 } } },
    { IncomingDiceTypeTemplate.Type3, new int[2, 2] { { 1, 0 }, { 1, 0 } } },
